        ...
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-sans">
            <div className="w-full max-w-[440px]">
                ...
                <div className="text-center mb-8">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-white rounded-2xl shadow-sm border border-slate-100 mb-6 mx-auto">
                        <ShieldCheck className="w-8 h-8 text-amber-500" strokeWidth={2} />
                    </div>
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">GRACE ERP</h1>
