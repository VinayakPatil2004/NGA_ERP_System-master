...
const ResetPassword = () => {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-[#000B1A] flex items-center justify-center p-6 relative">
                <div className="w-full max-w-[450px] bg-white/5 backdrop-blur-2xl rounded-[2.5rem] border border-white/10 p-12 text-center shadow-3xl">
    ...
    return (
        <div className="min-h-screen bg-[#000B1A] flex items-center justify-center p-6 relative overflow-hidden">
            <div className="w-full max-w-[450px] relative z-10 transition-all duration-500">
                ...
                <div className="bg-white/5 backdrop-blur-2xl rounded-[2.5rem] border border-white/10 p-10 shadow-3xl">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    required
                                    placeholder="••••••••••••"
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-white text-sm outline-none focus:border-amber-400/50 focus:bg-white/10 transition-all font-bold tracking-[0.2em]"
