...
const PrimaryReport1to2 = ({
    ...
    // Fill up empty rows up to 6 for Scholastic
    ...
    // List of co-scholastic areas expected in 1st-2nd
            ...
            <div>
                ...
                <div style={{
                    ...
                    <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px 30px' }}>
                        {[
                            ...
                            <div key={label} style={{
                                display: 'flex', gap: '5px', fontSize: '12px', color: '#000',
                ...
                <div className="mb-5">
                    <div className="flex gap-4">
                            ...
                            <table className="w-full border-collapse border border-black text-[10px]">
                                <thead>
                                    <tr>
                                        ...
                                        <th colSpan={8} className="border border-slate-800 px-2 py-2 text-center bg-[#FDE68A] font-bold">
                                            Term - 1 (100 Marks)
                                        </th>
                                    </tr>
                                    <tr className="bg-[#FDE68A]">
                                        ...
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Unit I<br />Written<br /><span className="text-[8px]">(20)</span></th>
                                        ...
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Project<br /><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Oral<br /><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Note<br />Book<br /><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Term 1<br />Written<br /><span className="text-[8px]">(40)</span></th>
                                ...
                                <tbody>
                                    {paddedTerm1.map((row, idx) => (
                                        <tr key={idx}>
                                            ...
                                            <td className="border border-slate-800 px-1 py-2 text-center">{row.class_test || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-2 text-center">{row.project || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-2 text-center">{row.oral || '\u00A0'}</td>
                        ...
                        {/* Signatures Term 1 */}
                        <div className="w-56 pl-2 flex flex-col pt-2 text-[11px] font-bold space-y-5">
                            <div className="uppercase underline underline-offset-4 decoration-2 mb-4">Term I Signature :</div>
...
export default PrimaryReport1to2;
