...
const PrimaryReport3to5 = ({ 
    ...
    // List of co-scholastic areas expected in 3rd-5th
        ...
        <div className="bg-white print:m-0 w-full max-w-[210mm] min-h-[297mm] mx-auto p-6 pb-4 text-[#001736] print:p-6 print:pb-4 print:shadow-none shadow-xl border border-slate-200 flex flex-col justify-between">
            ...
            <div>
                ...
                <div style={{ display: 'flex', gap: '30px', alignItems: 'center',
                    borderBottom: '1.5px solid #000', paddingBottom: '10px', marginBottom: '25px',
                    backgroundColor: '#fff' }}>
                    ...
                    <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px 30px' }}>
                        {[
                            ...
                            <div key={label} style={{ display: 'flex', gap: '5px', fontSize: '12px', color: '#000',
                                backgroundColor: '#fff', alignItems: 'flex-end', gridColumn: span2 ? 'span 2' : 'auto' }}>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                            <table className="w-full border-collapse border border-black text-[11px]">
                                <thead>
                                    <tr>
                                        <th colSpan={2} className="border border-slate-800 px-2 py-1 text-left bg-transparent text-[11px] font-bold">
                                            Scholastic Area
                                        </th>
                                        <th colSpan={8} className="border border-slate-800 px-2 py-1 text-center bg-[#FDE68A] font-bold">
                                            Term - 1 (100 Marks)
                                        </th>
                                    </tr>
                                    <tr className="bg-[#FDE68A]">
                                        ...
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Unit 1<br/>Written<br/><span className="text-[8px]">(20)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Class<br/>Test<br/><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Project<br/><span className="text-[8px]">(5)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Oral<br/><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Note<br/>Book<br/><span className="text-[8px]">(5)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Term 1<br/>Written<br/><span className="text-[8px]">(50)</span></th>
                                        <th className="border border-slate-800 px-1 py-2 w-12 text-center leading-tight">Total<br/>Out of<br/><span className="text-[8px]">(100)</span></th>
                                ...
                                <tbody>
                                    {paddedTerm1.map((row, idx) => (
                                        <tr key={idx}>
                                            <td className="border border-slate-800 px-1 py-1 text-center font-bold">{row.subject_name ? idx + 1 : '\u00A0'}</td>
                                            <td className="border border-slate-800 px-2 py-1 font-bold uppercase">{row.subject_name || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center">{row.unit_written || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center">{row.class_test || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center">{row.project || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center">{row.oral || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center">{row.notebook || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center">{row.term_written || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-1 py-1 text-center font-bold">{row.total_obtained || '\u00A0'}</td>
                                            <td className="border border-slate-800 px-2 py-1 text-center font-bold">{row.grade || '\u00A0'}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        {/* Signatures Term 1 */}
                        <div className="w-56 pl-2 flex flex-col pt-2 text-[12px] font-bold space-y-4">
                            <div className="uppercase underline underline-offset-4 decoration-2 mb-3">Term I Signature :</div>
                ...
                <div className="mb-3">
                    <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                            <table className="w-full border-collapse border border-black text-[11px]">
                                <thead>
                                    ...
                                    <tr className="bg-[#FDE68A]">
                                        <th className="border border-slate-800 px-1 py-1 w-8 text-center leading-tight">Sr.<br/>No.</th>
                                        <th className="border border-slate-800 px-2 py-1 text-left w-48">Subject</th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Unit 1<br/>Written<br/><span className="text-[8px]">(20)</span></th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Class<br/>Test<br/><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Project<br/><span className="text-[8px]">(5)</span></th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Oral<br/><span className="text-[8px]">(10)</span></th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Note<br/>Book<br/><span className="text-[8px]">(5)</span></th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Term 1<br/>Written<br/><span className="text-[8px]">(50)</span></th>
                                        <th className="border border-slate-800 px-1 py-1 w-12 text-center leading-tight">Total<br/>Out of<br/><span className="text-[8px]">(100)</span></th>
                                        <th className="border border-slate-800 px-2 py-1 w-12 text-center font-bold">Grade</th>
                                    </tr>
                                </thead>
                                <tbody>
                        ...
                        {/* Signatures Term 2 */}
                        <div className="w-56 pl-2 flex flex-col pt-2 text-[12px] font-bold space-y-4">
                            <div className="uppercase underline underline-offset-4 decoration-2 mb-3">Term II Signature :</div>
                            <div className="flex justify-between items-end">
                                <span>Class Teacher</span>
                                <span className="w-24 border-b border-dotted border-black"></span>
                            </div>
                ...
                <div className="flex justify-between gap-8 mb-2 mt-5">
                    {/* Co-Scholastic Box */}
                    <div className="w-[45%]">
                        <table className="w-full border-collapse border border-black text-[11px]">
                            <thead>
...
export default PrimaryReport3to5;
