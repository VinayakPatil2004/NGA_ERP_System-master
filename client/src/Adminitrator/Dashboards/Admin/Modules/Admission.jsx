            ...
            >
                ...
                <div className="flex items-center gap-2 lg:gap-3">
                    ...
                    <button
                        ...
                        className="lg:hidden w-9 h-9 flex items-center justify-center bg-white text-[#001736] rounded-md transition-all shadow-xl active:scale-95 shrink-0"
                    ...
                    <button
                        ...
                        className="w-9 h-9 flex items-center justify-center bg-white text-[#001736] rounded-md transition-all shadow-xl active:scale-95 shrink-0 lg:w-auto lg:h-auto lg:p-3 lg:border lg:border-white/10 lg:rounded-md lg:hover:bg-gray-300 lg:cursor-pointer lg:hover:text-gray-900 lg:active:rotate-180 lg:duration-700 lg:text-black"
                        title="Sync Registry"
                    >
                        <RefreshCw className="w-5 h-5 lg:w-[18px] lg:h-[18px]" />
                    </button>
                    ...
                    <div className={`flex flex-col lg:flex-row items-center justify-between gap-4 py-6 rounded-2xl mb-4 ${!isMobileSearchOpen ? 'hidden lg:flex' : 'flex animate-in slide-in-from-top-2 duration-300'}`}>
                        <div className="flex flex-1 max-w-md w-full relative group">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-4 py-2 border border-black rounded-md text-primary text-[10px] font-black uppercase tracking-widest outline-none shadow-sm transition-all bg-white hover:bg-slate-50"
                            />
                        </div>
                        ...
                        <div className="grid grid-cols-2 lg:flex items-center gap-3 w-full lg:w-auto">
                            <button
                                onClick={() => setShowDirectEnrollModal(true)}
                                className="hidden cursor-pointer lg:flex px-6 py-2 bg-primary btn-add-institutional rounded-md font-black text-[10px] lg:text-[11px] uppercase tracking-widest items-center justify-center gap-3 active:scale-95 transition-all"
                            >
                                <Plus size={18} />
                                Add Student
                            </button>
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className={`w-full cursor-pointer p-2.5 rounded-md transition-all flex items-center justify-center gap-2 group shadow-sm ${showFilterMenu ? 'bg-primary text-white' : 'bg-white btn-add-institutional'}`}
                                >
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full p-2 bg-white border border-institutional rounded-md text-[10px] font-bold uppercase outline-none transition-all text-primary hover:bg-slate-50"
                                                />
                                            </div>
                                            <div className="pt-2">
                                                <button
                                                    onClick={() => { setFilterGrade(''); setFilterDate(''); setCurrentPage(1); }}
                                                    className="w-full py-3 bg-white text-primary border border-institutional rounded-md text-[9px] font-black uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-sm"
                                                >
                            ...
                            <div className="flex items-center gap-2 bg-white border p-1 rounded-md shadow-sm">
                                <button
                                    ...
                                    className="p-1 cursor-pointer hover:bg-emerald-50 text-emerald-600 rounded-lg transition-all"
                                    title="Export Excel"
                                >
                                ...
                                <button
                                    ...
                                    className="p-1 cursor-pointer hover:bg-rose-50 text-rose-600 rounded-lg transition-all"
                                    title="Export PDF"
                                >
                            ...
                            <tr key={app.id} className="hover-table-row transition-colors group">
                                ...
                                <td className="px-4 py-4 text-center border-b border-black">
                                    <div className="flex items-center justify-center gap-2">
                                        <button
                                            onClick={() => navigate(`view/${app.id}`)}
                                            className="p-2 bg-white border border-black text-table-cell rounded-md cursor-pointer hover:bg-gray-400 hover:text-white transition-all shadow-sm active:scale-95"
                                            title="View Details"
                                        >
                ...
                <div className="fixed inset-0 bg-[#001736]/90 backdrop-blur-md z-110 flex items-center justify-center p-4 overflow-y-auto">
                    <div className="bg-white rounded-2xl w-full max-w-2xl border border-white/20 shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
                        <div className="p-12 text-center">
                            ...
                            <button onClick={() => setShowEnrollModal(false)} className="mt-8 px-8 py-3 bg-black text-white rounded-md font-bold uppercase text-xs">Close</button>
                        </div>
                    </div>
                </div>
            )}
