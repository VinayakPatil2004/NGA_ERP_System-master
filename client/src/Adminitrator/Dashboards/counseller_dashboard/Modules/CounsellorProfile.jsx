...
const CounsellorProfile = ({ toggleSidebar }) => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                // A counsellor is a staff member, so we fetch from staff records
    ...
    return (
        <div className="p-0 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 font-sans text-left">
            <ModuleHeader
